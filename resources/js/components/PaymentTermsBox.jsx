    ...
    <div className="flex items-start gap-3">
      ...
      <div>
        <p className="font-label text-xs font-semibold uppercase tracking-[0.12em] sm:text-sm">
          100% Advance • Order confirmed only after payment • 20 Days Production
        </p>
        <p className="mt-2 text-sm leading-relaxed">
          Share your payment receipt on WhatsApp — the order is confirmed within 6 hours and the
          20-day production clock starts at confirmation. A GST invoice is auto-generated for every
          confirmed order.
        </p>
      </div>
    </div>
